...
export function AppSidebar({ brainViewerControls, ...props }: React.ComponentProps<typeof Sidebar> & {  
  brainViewerControls?: {  
    opacity: number;  
    clipPlane: boolean;  
  ...
  return (  
    <Sidebar collapsible="offcanvas" {...props}>  
      ...
      <SidebarContent>  
        ...
        <NavSecondary items={navSecondary} brainViewerControls={brainViewerControls} className="mt-auto" />  
      </SidebarContent>  
